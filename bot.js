...
.setTitle("Neptune bot İstatistik")
.setColor("RED")
.setTimestamp()
...
client.on("message", async msg => {
    ...
    if(
      msg.content.toLowerCase() == "31"//-- KİŞİNİN YAZDIĞI  
      
    ) {
       return msg.channel.send("çekelimmi"); ///- BOTUN VERDİĞİ CEVAP
    }
...
client.on("guildCreate", guild => {
  ...
  kanal.send(
    "Beni Eklediğin İçin Teşşekürler Neptune Bot :bell:"
  );
});
